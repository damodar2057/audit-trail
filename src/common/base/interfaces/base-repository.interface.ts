...
import { DeepPartial, EntityManager, FindManyOptions, FindOneOptions, FindOptionsWhere, InsertResult, ObjectId, ObjectLiteral, SelectQueryBuilder } from "typeorm";
...
export interface IBaseRepository<T extends BaseEntity> {
  ...
  update(criteria: FindOptionsWhere<T>, partialEntity: QueryDeepPartialEntity<T>): Promise<T>;
