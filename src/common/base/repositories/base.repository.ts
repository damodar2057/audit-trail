...
import { DeepPartial, EntityManager, FindManyOptions, FindOneOptions, FindOptionsWhere, InsertResult, Repository, SelectQueryBuilder } from "typeorm";
...
export abstract class BaseRepository<T extends BaseEntity> implements IBaseRepository<T>{
    ...
    async update(criteria: FindOptionsWhere<T>, partialEntity: QueryDeepPartialEntity<T>): Promise<T> {
